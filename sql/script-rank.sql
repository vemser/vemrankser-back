CREATE
USER VEMRANKSERTESTE IDENTIFIED BY oracle;
GRANT CONNECT TO VEMRANKSERTESTE;
GRANT CONNECT, RESOURCE, DBA TO VEMRANKSERTESTE;
GRANT
CREATE
SESSION TO VEMRANKSERTESTE;
GRANT DBA TO VEMRANKSERTESTE;
GRANT
CREATE VIEW, CREATE PROCEDURE, CREATE SEQUENCE to VEMRANKSERTESTE;
GRANT
UNLIMITED
TABLESPACE TO VEMRANKSERTESTE;
GRANT CREATE
MATERIALIZED VIEW TO VEMRANKSERTESTE;
GRANT
CREATE TABLE TO VEMRANKSERTESTE;
GRANT
GLOBAL
QUERY REWRITE TO VEMRANKSERTESTE;
GRANT
SELECT ANY TABLE TO VEMRANKSERTESTE;
